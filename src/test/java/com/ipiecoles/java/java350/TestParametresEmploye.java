...
public class TestParametresEmploye {
	...
	public void parameterizedTestGetPrimeAnnuelle(String matricule, Integer performance,
			LocalDate dateEmbauche, Double prime, Double tempsPartiel) {
		//Given
	...
	static Stream<Arguments> matriculePerformancePrimeTempsPartiel (){
		...
		return Stream.of(
				Arguments.of(null, null, null, 1000d, null),
				Arguments.of("0", null, null, 1000d, null),
				Arguments.of("0", 1, null, 1000d, null),
				Arguments.of("0", -1, null, 1000d, null),
				Arguments.of("0", 2, null, 2300d, null),
