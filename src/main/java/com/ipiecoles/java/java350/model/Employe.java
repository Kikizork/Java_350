...
public class Employe {
	 ...
	 */
	public Integer getNombreDeRttPourUneAnnee(LocalDate localDate) throws NullPointerException {

		// Teste la condition null retourne une erreur
		if (localDate == null) {
			LOGGER.error("Erreur fonction {}, paramètre localDate ne peut être null", new Object() {
		...
		case TUESDAY:
			break;
		default:
			// Jamais utilisée vu que une localDate est forcement au bon format ou null et
			// la condition est testée plus haut
			break;
		}
	 ...
	 * 
	 */
	public void augmenterSalaire(Double pourcentage) throws NullPointerException, EmployeException {
